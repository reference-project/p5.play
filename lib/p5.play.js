...
function Animation(pInst) {
  ...
  */
  ...
  this.update = function() {
    ...
    if ( this.playing && cycles%this.frameDelay === 0)
    {
      ...
      else if (this.looping || this.shouldPlayAgain) //advance frame
      {
        //reset shouldPlayAgain
  ...
  */
  ...
  /**
  * True if animation should reset to frame 0 on next draw.
  *
  * @property shouldPlayAgain
  * @type {Boolean}
  */
  this.shouldPlayAgain = false;
