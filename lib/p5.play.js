...
p5.prototype._warn = function(message) {
  ...
  p5.Transform2D.prototype.mult = function(other) {
    ...
    this.mat3[0] = srcL[0]*srcR[0] + srcL[1]*srcR[3];
    this.mat3[1] = srcL[0]*srcR[1] + srcL[1]*srcR[4];
    this.mat3[2] = srcL[0]*srcR[2] + srcL[1]*srcR[5] + srcL[2];

    this.mat3[3] = srcL[3]*srcR[0] + srcL[4]*srcR[3];
    this.mat3[4] = srcL[3]*srcR[1] + srcL[4]*srcR[4];
    this.mat3[5] = srcL[3]*srcR[2] + srcL[4]*srcR[5] + srcL[5];
