  ...
  */
  ...
  this._collideWithSprite = function(type, target, callback) {
    ...
    if (type === 'collide' || type === 'displace' || type === 'bounce') {
      ...
      if (type === 'bounce') {
        var thisOldVelOnAxis = p5.Vector.project(this.velocity, displacement);
        var targetOldVelOnAxis = p5.Vector.project(target.velocity, displacement);
        ...
        if (this.immovable) {
          ...
          m1 = target.mass / totalMass;
          m2 = this.mass / totalMass;
        }
        ...
        this.velocity.sub(thisOldVelOnAxis).sub(newVel1.mult(this.restitution));
        target.velocity.sub(targetOldVelOnAxis).sub(newVel2.mult(target.restitution));
      }
    }
