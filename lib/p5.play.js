  ...
  */
  ...
  this._findDisplacement = function(target) {
    ...
    if (squareVelocity > centerSquareDistanceOnVelocityAxis) {
      ...
      var timestep = radiusOnVelocityAxis / Math.sqrt(squareVelocity);
      ...
      if (timestep < 1) {
        ...
        for (var i = timestep; i < 1; i += timestep) {
          ...
          if (displacement.x !== 0 || displacement.y !== 0) {
            ...
            // Note that we _don't_ restore the sprites' positions here.
            // TODO: Immovable sprites should get their original position
            //       back, even if the collision happened earlier.
            return displacement;
          }
        }
