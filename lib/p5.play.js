...
p5.prototype._warn = function(message) {
  ...
  p5.Transform2D.prototype.equals = function(other) {
    ...
    // For 2D transforms only the first six values can vary, so only check those.
    for (var i = 0; i < 6; i++) {
  ...
  p5.Transform2D.mult = function(t1, t2) {
    return new p5.Transform2D(t1).mult(t2);
  };

  p5.Transform2D.prototype.mult = function(other) {
    var srcL = new Float32Array(this.mat3);
    var srcR = new p5.Transform2D(other).mat3;

    this.mat3[0] = srcL[0]*srcR[0] + srcL[1]*srcR[3] + srcL[2]*srcR[6];
    this.mat3[1] = srcL[0]*srcR[1] + srcL[1]*srcR[4] + srcL[2]*srcR[7];
    this.mat3[2] = srcL[0]*srcR[2] + srcL[1]*srcR[5] + srcL[2]*srcR[8];

    this.mat3[3] = srcL[3]*srcR[0] + srcL[4]*srcR[3] + srcL[5]*srcR[6];
    this.mat3[4] = srcL[3]*srcR[1] + srcL[4]*srcR[4] + srcL[5]*srcR[7];
    this.mat3[5] = srcL[3]*srcR[2] + srcL[4]*srcR[5] + srcL[5]*srcR[8];

    this.mat3[6] = srcL[6]*srcR[0] + srcL[7]*srcR[3] + srcL[8]*srcR[6];
    this.mat3[7] = srcL[6]*srcR[1] + srcL[7]*srcR[4] + srcL[8]*srcR[7];
    this.mat3[8] = srcL[6]*srcR[2] + srcL[7]*srcR[5] + srcL[8]*srcR[8];
