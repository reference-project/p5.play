...
<head>
    <meta charset="utf-8">
    <title>__temp_docs/assets/vendor/bootstrap/js/bootstrap.min.js - p5.play</title>
                ...
                <div id="docs-main">
                    <div class="content">
                        <div class="page-header">
                            <h1>__temp_docs/assets/vendor/bootstrap/js/bootstrap.min.js <small>File</small></h1>
                        </div>
